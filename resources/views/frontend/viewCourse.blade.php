                            ...
                            <ul>
                                <li>
                                    <div class="teacher-name">
                                        <div class="thum">
                                            <img src="{{ asset('frontend/assets') }}/images/course/teacher/t-1.jpg"
                                                alt="Teacher">
                                        </div>
                                        <div class="name">
                                            <span>Teacher</span>
                                    ...
                                    <div class="instructor-cont">
                                        <div class="instructor-author">
                                            <div class="author-thum">
                                                <img src="{{ asset('frontend/assets') }}/images/instructor/i-1.jpg"
                                                    alt="Instructor">
                                            </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="singel-reviews">
                                                    <div class="reviews-author">
                                                        <div class="author-thum">
                                                            <img src="{{ asset('frontend/assets') }}/images/review/r-1.jpg"
                                                                alt="Reviews">
                                                        </div>
                                                        <div class="author-name">
                                                            <h6>Bobby Aktar</h6>
                                            ...
                                            <li>
                                                <div class="singel-reviews">
                                                    <div class="reviews-author">
                                                        <div class="author-thum">
                                                            <img src="{{ asset('frontend/assets') }}/images/review/r-2.jpg"
                                                                alt="Reviews">
                                                        </div>
                                                        <div class="author-name">
                                                            <h6>Humayun Ahmed</h6>
                                            ...
                                            <li>
                                                <div class="singel-reviews">
                                                    <div class="reviews-author">
                                                        <div class="author-thum">
                                                            <img src="{{ asset('frontend/assets') }}/images/review/r-3.jpg"
                                                                alt="Reviews">
                                                        </div>
                                                        <div class="author-name">
                                                            <h6>Tania Aktar</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                                ...
                                <ul>
                                    <li><i class="fa fa-clock-o"></i>Total Classes : <span>{{ $course->total_class }}</span>
                                    </li>
                                ...
                                <div class="col-md-6">
                                    <div class="singel-course mt-30">
                                        ...
                                        <div class="cont">
                                            ...
                                            <span>({{ $relatedCourse->total_class }} Classes)</span>
                                            <a href="{{ route('view-course', $relatedCourse->slug) }}">
