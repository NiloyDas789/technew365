...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div x-show="open" class="modal-one" x-on:click.outside="open = false">
                        ...
                        <div class="header d-flex justify-content-between">
                            ...
                            <div>
                                <button type="button" x-on:click="open = false" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        </div>
                    <hr>
                    <br>
                        ...
                        <div class="footer">
                            <button type="button"  x-on:click="open = false"  class="main-btn secondary-btn rounded-md btn-hover float-end mr-20">Close</button>
                            <button type="button" class="main-btn primary-btn rounded-md btn-hover float-end mr-10">Save changes</button>
                        </div>

                </div>
                <button @click="open = ! open"  class="main-btn primary-btn rounded-md btn-hover">Open-one</button>
            </div>
        </div>
        <!-- ========== title-wrapper end ========== -->
        <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img
                                                src="backend/assets/images/products/product-mini-1.jpg"
                                                alt=""
                                            />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img
                                                src="backend/assets/images/products/product-mini-2.jpg"
                                                alt=""
                                            />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img
                                                src="backend/assets/images/products/product-mini-3.jpg"
                                                alt=""
                                            />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img
                                                src="backend/assets/images/products/product-mini-4.jpg"
                                                alt=""
                                            />
                                        </div>
