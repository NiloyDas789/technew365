...
@section('title', 'Create Latest Technews')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style settings-card-1 mb-30">
                    ...
                    @endif
                    <form action="{{ route('latest-tech.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="profile-info">
                            <div class="row">
                                @include('backend.latestTech.form')
                                <div class="col-12">
