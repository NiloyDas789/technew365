...
<div class="col-lg-12">
    <div class="input-style-1">
        ...
        <input type="text" name="location" value="{{ $event->location ?? old('location') }}" id="location"
            class="@error('location') is-invalid @enderror" placeholder="Event Title">
        @error('location')
            <div class="alert alert-danger mt-1">{{ $message }}</div>
        @enderror
    </div>
...
<div class="col-lg-12">
    <div class="input-style-1">
        ...
        <input type="date" name="date" value="{{ $event->date ?? old('date') }}" id="date"
            class="@error('date') is-invalid @enderror" placeholder="Event Title">
        @error('date')
            <div class="alert alert-danger mt-1">{{ $message }}</div>
        @enderror
    </div>
...
<div class="col-lg-12">
    <div class="input-style-2">
        ...
        <input type="time" name="start_time"
            ...
            id="start_time" class="@error('start_time') is-invalid @enderror" placeholder="Event Title">
        @error('start_time')
            <div class="alert alert-danger mt-1">{{ $message }}</div>
        @enderror
    </div>
...
<div class="col-lg-12">
    <div class="input-style-2">
        ...
        <input type="time" name="end_time"
            ...
            id="end_time" class="@error('end_time') is-invalid @enderror" placeholder="Event Title">
        @error('end_time')
            <div class="alert alert-danger mt-1">{{ $message }}</div>
        @enderror
    </div>
