    ...
    <div class="uk-container">
        ...
        <div class="uk-width-3-4@xl uk-width-3-4@l uk-width-1-1@m uk-width-1-1@s uk-margin-medium-top uk-position-relative uk-height-1-1 impx-features-content" data-uk-grid>
            ...
            <div class="impx-intro uk-text-left">
                ...
                <p class="uk-margin-remove uk-text-uppercase">"A combination of location, amenities, quality, price, and reputation to provide a great experience for guests."</p>
            </div>
            <!-- Intro Text End -->
            <ul class="uk-child-width-1-3@xl uk-child-width-1-3@l uk-child-width-1-3@m uk-child-width-1-2@s impx-features-hl uk-grid-medium uk-grid-match uk-margin-top impx-margin-top-small" data-uk-grid>
                <li><!-- Reason Item #1 -->
                    <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color1 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove  impx-text-lighter">Best value for families, with amenities like spacious rooms and on-site dining options.</p>
                ...
                <li><!-- Reason Item #2 -->
                     <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color2 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove impx-text-lighter">Best services, including personalized attention, exceptional housekeeping, business services, and recreational activities.</p>
                ...
                <li><!-- Reason Item #3 -->
                    <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color3 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove impx-text-lighter">Best facilities, including comfortable and well-equipped rooms, on-site amenities, meeting and event facilities and a convenient location.</p>
                ...
                <li><!-- Reason Item #4 -->
                     <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color4 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove impx-text-lighter">High-quality customer service, clean accommodations, and a range of amenities. We also communicate and take feedbacks from our guests and assure their satisfaction.</p>
                ...
                <li><!-- Reason Item #5 -->
                     <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color5 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove impx-text-lighter">Stunning view of the surrounding landscape, such as mountain range, forest,  river, lake attracts our guests seeking a relaxing environment and outdoor activities.</p>
                ...
                <li><!-- Reason Item #6 -->
                    <div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium color6 impx-feature-item uk-position-relative">
                        ...
                        <p class="uk-margin-remove impx-text-lighter">Enjoyable experience through comfortable accommodations, quality amenities, and attentive customer service.</p>
