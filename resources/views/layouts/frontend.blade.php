...
<body>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150"
            style="background-image: url({{ asset('frontend/assets') }}/images/slider/s-1.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150"
            style="background-image: url({{ asset('frontend/assets') }}/images/slider/s-2.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150"
            style="background-image: url({{ asset('frontend/assets') }}/images/slider/s-3.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('frontend/assets') }}/images/course/teacher/t-5.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
                        ...
                        <ul>
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets') }}/images/all-icon/f-1.png"
                                            alt="icon">
                                    </div>
                                    <div class="cont">
                                        <h4> Modern Lab</h4>
                            ...
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets') }}/images/all-icon/f-2.png"
                                            alt="icon">
                                    </div>
                                    <div class="cont">
                                        <h4>Student & Client Support</h4>
                                        <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem sem
                                            quibibendum sem nibhutis.</p>
                                    </div>
                                </div> <!-- singel feature -->
                            ...
                            <li>
                                <div class="singel-feature">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets') }}/images/all-icon/f-3.png"
                                            alt="icon">
                                    </div>
                                    <div class="cont">
                                        <h4>Job Placement</h4>
                    ...
                    <div class="teachers mt-20">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets') }}/images/teachers/t-2.jpg"
                                            alt="Teachers">
                                    </div>
                                    <div class="cont">
                                        <a href="teachers-singel.html">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets') }}/images/teachers/t-3.jpg"
                                            alt="Teachers">
                                    </div>
                                    <div class="cont">
                                        <a href="teachers-singel.html">
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets') }}/images/teachers/t-4.jpg"
                                            alt="Teachers">
                                    </div>
                                    <div class="cont">
                                        <a href="teachers-singel.html">
